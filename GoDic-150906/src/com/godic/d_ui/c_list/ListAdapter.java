...
public class ListAdapter extends
	...
	public ListAdapter(ListActivity activity, Context context) {
		mContext = context;
		mActivity = activity;
		// anim_click = AnimationUtils.loadAnimation(mContext,
		// R.anim.click_effect);
	}
	...
	public class ListViewHolder extends RecyclerView.ViewHolder {
		...
		Button bt_open, bt_edit, bt_delete, bt_cancel, bt_more;
		ImageView iv_capture;
		int listPosition, dbPosition;
		TableLayout tlo_content;
		...
		public ListViewHolder(View itemView) {
			...
			// tlo_content = (TableLayout) itemView
			// .findViewById(R.id.list_madapt_tlo_content);
			iv_capture = (ImageView) itemView.findViewById(R.id.list_madapt_iv);
			bt_open = (Button) itemView.findViewById(R.id.list_madapt_bt_open);
			...
			bt_more = (Button) itemView.findViewById(R.id.list_madapt_bt_more);
			...
			bt_open.setOnClickListener(btClickListener);
			...
			bt_more.setOnClickListener(btClickListener);
		}
		...
		OnClickListener btClickListener = new OnClickListener() {
			...
			public void onClick(View v) {
				switch (v.getId()) {
				case R.id.list_madapt_bt_more:
					clickBtMore();
					break;
				case R.id.list_madapt_bt_open:
					clickBtOpen();
					break;
		...
		void clickBtOpen() {
			...
			itemData.setData(title, date, listDAO.getWlistInCursor(dbPosition),
	...
	public void onBindViewHolder(ListViewHolder holder, int position) {
		...
		/*
		 * for (int i = 0; i < 2; i++) { TableRow tableRow = new
		 * TableRow(mContext); tableRow.setLayoutParams(new
		 * TableLayout.LayoutParams( TableLayout.LayoutParams.WRAP_CONTENT,
		 * TableLayout.LayoutParams.WRAP_CONTENT));
		 * 
		 * for(int j=0; j<4; j++) { tv_content = new TextView(mContext);
		 * holder.tv_content.setText(listDAO.getWlistStrInCursor()); } }
		 */
	}
