...
public class AppSession implements UpdateCallbackInterface
{
    ...
    public AppSession(AppControl sessionControl)
    {
    ...
    public void initAR(Activity activity, int screenOrientation)
    {
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new AppException(
                AppException.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new AppException(
                    AppException.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws AppException
    {
        ...
        } catch (AppException exceptionTriggerAuto)
        {
    ...
    public void stopAR() throws AppException
    {
        ...
        synchronized (mShutdownLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new AppException(
                    AppException.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new AppException(
                    AppException.TRACKERS_DEINITIALIZATION_FAILURE,
            ...
            if (result)
            {
                ...
                if (initTrackersResult)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        vuforiaException = new AppException(
                            AppException.LOADING_TRACKERS_FAILURE,
                            logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }
                ...
                {
                    vuforiaException = new AppException(
                        AppException.TRACKERS_INITIALIZATION_FAILURE,
    ...
    private boolean setFocusMode(int mode) throws AppException
    {
        ...
        if (!result)
            throw new AppException(
                AppException.SET_FOCUS_MODE_FAILURE,
