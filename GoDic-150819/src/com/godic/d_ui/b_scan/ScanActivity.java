...
public class ScanActivity extends AppCompatActivity implements AppControl {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rlo_help = (RelativeLayout) findViewById(id.help_rlo);
		cb_help = (CheckBox) findViewById(id.help_cb_close);
		cb_help.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				rlo_help.setVisibility(View.GONE);
			}
		});
